...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/ytetonghop/public/uploads";  ///webroot/uploads';
...
// Local filesystem
$moxieManagerConfig['filesystem.local.wwwroot'] = $_SERVER["DOCUMENT_ROOT"]."/ytetonghop/public/uploads";
$moxieManagerConfig['filesystem.local.urlprefix'] = '{proto}://{host}/ytetonghop/public/uploads/';
